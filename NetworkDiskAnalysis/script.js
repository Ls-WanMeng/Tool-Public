...
const CONTACTS = {
    MT: 'https://bbs.binmt.cc/home.php?mod=space&uid=145182&do=profile',
    github: 'https://github.com/Ls-WanMeng',
    email: 'xinruliangsui@163.com',
...
function openContact(type) {
    switch(type) {
        ...
        *弹窗加复制
        *
            showToast(`MT主页: ${CONTACTS.MT}`, 'success');
            navigator.clipboard.writeText(CONTACTS.MT).catch(() => {});
        */  
        window.open(CONTACTS.MT, '_blank');
